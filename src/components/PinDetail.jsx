  ...
  return (
    ...
    <div className='flex xl-flex-col flex-col m-auto bg-white' style={{maxWidth:'1500px', borderRadius:'32px'}}>
      ...
      <div className='w-full p-5 flex-1 xl:min-w-620'>
        ...
        >
          <img src={pinDetails.postedBy?.image} alt="user-profile" className='w-7 h-7 rounded-full object-cover' />
          <p className='font-md text-sm capitalize'>{pinDetails.postedBy?.userName}</p>
        </Link>
